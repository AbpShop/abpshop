<template>
    <div class="article-manager">
        <div class="i-layout-page-header">
            <PageHeader :title="$route.meta.title" hidden-breadcrumb></PageHeader>
        </div>
                                        ...
                                        <div class="box-card right">
                                            ...
                                            <Form  ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="100" class="mt20">
                                                ...
                                                <div v-if="formValidate.type === 'miniprogram'">
                                                    ...
                                                    <FormItem label="备用网页" prop="pagepath">
                                                        <Input v-model="formValidate.pagepath" placeholder="请填写备用网页" class="spwidth"></Input>
                                                    </FormItem>
                                                    <FormItem label="小程序路径" prop="url">
                                                        <Input v-model="formValidate.url" placeholder="请填写小程序路径" class="spwidth"></Input>
                                                    </FormItem>
                                                </div>
