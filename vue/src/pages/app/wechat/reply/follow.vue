                            ...
                            <Col span="24" class="userAlert">
                                <div class="box-card right">
                                    <Form ref="formValidate" :model="formValidate" :rules="ruleValidate"
                                        ...
                                        <FormItem label="规则内容：" prop="content" v-if="formValidate.type === 'text'">
                                            <Input v-model="formValidate.data.content" placeholder="请填写规则内容"
        ...
        methods: {
            ...
            details () {
                ...
                keywordsinfoApi(url, data).then(async res => {
                    let info = res.data.info || {}, data = info.data || {};
                    this.formValidate = {
                        status: info.status,
                        type: info.type,
                        key: info.key,
