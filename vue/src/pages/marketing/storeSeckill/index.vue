<template>
    <div>
        <div class="i-layout-page-header">
            <PageHeader class="product_tabs" title="秒杀商品" hidden-breadcrumb></PageHeader>
        </div>
        <Card :bordered="false" dis-hover class="ivu-mt">
            <Form ref="tableFrom" :model="tableFrom"  :label-width="labelWidth" :label-position="labelPosition" @submit.native.prevent>
                ...
                <Row type="flex" class="mb20">
                    <Col v-bind="grid">
                        <Button type="primary"  icon="md-add" @click="add" class="mr10">添加秒杀商品</Button>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 编辑
            edit (row) {
                this.$router.push({ path: '/admin/marketing/store_seckill/create/' + row.id });
            },
            // 删除
            del (row, tit, num) {
                let delfromData = {
