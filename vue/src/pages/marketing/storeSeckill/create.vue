                ...
                <Col span="23">
                    <Form class="form mt30" ref="formValidate" :model="formValidate" :rules="ruleValidate"  @on-validate="validate"
                        ...
                        <Col v-show="current === 1" type="flex">
                            ...
                            <Col v-bind="grid2">
                                <FormItem label="单次购买商品个数：" prop="num">
                                    <InputNumber placeholder="请输入单次购买商品个数" element-id="num" :precision="0"  v-model="formValidate.num" style="width: 100%"/>
                                </FormItem>
                            </Col>
                            <Col v-bind="grid2">
                                <FormItem label="排序：">
                            ...
                            <Col v-bind="grid2">
                                <FormItem label="开始时间：" prop="time_id">
                                    <div>
                                        <Select v-model="formValidate.time_id">
                            ...
                            <!--<Col v-bind="grid2">-->
                                <!--<FormItem label="秒杀价：" prop="price" label-for="price">-->
                                    <!--<InputNumber placeholder="请输入秒杀价" element-id="price"  v-model="formValidate.price" style="width: 100%"/>-->
                                <!--</FormItem>-->
                            <!--</Col>-->
                            <!--<Col v-bind="grid2">-->
                                <!--<FormItem label="原价：" prop="ot_price">-->
                                    <!--<InputNumber placeholder="请输入原价" element-id="ot_price"  v-model="formValidate.ot_price" style="width: 100%"/>-->
                                <!--</FormItem>-->
                            <!--</Col>-->
                            <!--<Col v-bind="grid2">-->
                                <!--<FormItem label="成本价：" prop="cost">-->
                                    <!--<InputNumber placeholder="请输入成本价" element-id="cost"  v-model="formValidate.cost" style="width: 100%"/>-->
                                <!--</FormItem>-->
                            <!--</Col>-->
                            <!--<Col v-bind="grid2">-->
                                <!--<FormItem label="库存：" prop="stock" label-for="stock">-->
                                    <!--<InputNumber placeholder="请输入库存" element-id="stock" :precision="0"  v-model="formValidate.stock" style="width: 100%"/>-->
                                <!--</FormItem>-->
                            <!--</Col>-->
                            <!--<Col v-bind="grid2">-->
                                <!--<FormItem label="销量：">-->
                            ...
                            <!--<Col v-bind="grid2">-->
                                <!--<FormItem label="邮费：">-->
                                    <!--<InputNumber placeholder="请输入邮费" element-id="postage" v-model="formValidate.postage" style="width: 100%"/>-->
                                <!--</FormItem>-->
                            <!--</Col>-->
                            <!--<Col v-bind="grid2">-->
        ...
        data () {
            return {
                ...
                ruleValidate: {
                    ...
                    num: [
                        { required: true, type: 'number', message: '请输入单次购买商品个数', trigger: 'blur' }
                    ],
                    temp_id: [
