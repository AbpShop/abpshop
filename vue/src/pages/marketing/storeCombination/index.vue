<template>
    <div>
        <div class="i-layout-page-header">
            <PageHeader title="拼团商品" hidden-breadcrumb></PageHeader>
        </div>
                ...
                <Row type="flex" :gutter="24">
                    ...
                    <Col v-bind="grid">
                        <FormItem label="商品搜索：" prop="store_name" label-for="store_name">
                            <Input search enter-button placeholder="请输入请输入商品名称,关键字,ID" v-model="formValidate.store_name" @on-search="userSearchs"/>
                        </FormItem>
                    </Col>
                </Row>
                <Row type="flex">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            // 编辑
            edit (row) {
                this.$router.push({ path: '/admin/marketing/store_combination/create/' + row.id });
            },
            // 删除
            del (row, tit, num) {
                let delfromData = {
