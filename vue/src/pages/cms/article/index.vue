                ...
                <Row type="flex" :gutter="24">
                    ...
                    <Col v-bind="grid">
                        <FormItem label="文章搜索："  label-for="title">
                            <Input search enter-button placeholder="请输入" v-model="artFrom.title" style="width:80%;" @on-search="userSearchs"/>
                        </FormItem>
                    </Col>
                </Row>
                <Row type="flex">
    ...
    export default {
        ...
        data () {
            return {
                ...
                loading: false,
                artFrom: {
                    pid: this.categoryId ? this.categoryId : 0,
                    title: '',
                    page: 1,
                    limit: 20
                },
        ...
        mounted () {
            this.artFrom.pid = this.categoryId;
            this.getList();
            this.getClass();
        },
        methods: {
