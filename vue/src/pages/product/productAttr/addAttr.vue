<template>
    <Modal
            ...
            title="添加商品规格"
            width="950">
        <Form  ref="formDynamic" :model="formDynamic" :rules="rules" class="attrFrom" :label-width="labelWidth" :label-position="labelPosition" @submit.native.prevent>
            <Row :gutter="24">
                <Col span="24">
                    <Col span="8" class="mb15">
                        <FormItem label="标题名称：" prop="rule_name">
                            <Input  placeholder="请输入标题名称" v-model="formDynamic.rule_name"  />
                        </FormItem>
                    </Col>
                </Col>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            labelWidth () {
                return this.isMobile ? undefined : 95;
            },
            labelPosition () {
