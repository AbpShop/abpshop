<template>
    <div>
        <div class="i-layout-page-header">
            <PageHeader class="product_tabs" title="客服管理" hidden-breadcrumb></PageHeader>
        </div>
        ...
        <Modal v-model="modals3" footer-hide scrollable   closable title="聊天记录"  width="700">
            <div v-if="isChat" class="modelBox">
                <Table :loading="loading3" highlight-row no-userFrom-text="暂无数据"
                       no-filtered-userFrom-text="暂无筛选结果"  :columns="columns3" :data="tableList3">
                    <template slot-scope="{ row, index }" slot="headimgurl">
                        <viewer>
                            <div class="tabBox_img">
                                <img v-lazy="row.headimgurl">
                ...
                <div class="acea-row row-right page">
                    <Page :total="total3" show-elevator show-total @on-change="pageChange3"
                          :page-size="formValidate3.limit"/>
                </div>
            </div>
            <div v-if="!isChat">
                <Button type="primary" @click="isChat=true">返回聊天记录</Button>
                <Table :loading="loading5" highlight-row no-userFrom-text="暂无数据" class="mt20"
                       no-filtered-userFrom-text="暂无筛选结果"  :columns="columns5" :data="tableList5">
                    <template slot-scope="{ row, index }" slot="avatar">
                        <viewer>
                            <div class="tabBox_img">
                                <img v-lazy="row.avatar">
                ...
                <div class="acea-row row-right page">
                    <Page :total="total5" show-elevator show-total @on-change="pageChange5"
